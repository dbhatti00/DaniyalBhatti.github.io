...
function toggleImage() {
    ...
    if (image.src.includes("hand.png")) {
        image.src = "models/handposed.png"; // Replace with the path to your wireframe image
    } else {
        image.src = "models/hand.png"; // Replace with the path to your render image
    }
}
