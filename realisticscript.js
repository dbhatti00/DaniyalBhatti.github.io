...
function toggleImage() {
    ...
    if (image.src.includes("realistic.jpg")) {
        image.src = "models/realisticsculpt.png"; // Replace with the path to your wireframe image
    } else if (image.src.includes("realisticsculpt.png")) {
        image.src = "models/realisticwire.png"; // Replace with the path to your render image
    }else{
        image.src = "models/realistic.jpg";
    }
