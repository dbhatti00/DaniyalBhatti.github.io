...
function toggleImage() {
    ...
    if (image.src.includes("style.png")) {
        image.src = "models/style2.png"; // Replace with the path to your wireframe image
    } else {
        image.src = "models/style.png"; // Replace with the path to your render image
    }
}