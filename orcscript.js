...
function toggleImage() {
    ...
    if (image.src.includes("orc.jpg")) {
        image.src = "models/orc2.jpg"; // Replace with the path to your wireframe image
    } else {
        image.src = "models/orc.jpg"; // Replace with the path to your render image
    }
}